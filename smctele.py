...
Original file is located at
    https://colab.research.google.com/drive/1uTP5brycCMAGWE7g83skffUL4gYMIhQu
"""
...
def detect_smc_signal(m1: pd.DataFrame) -> Optional[PendingSignal]:
    """
    Live version of your backtest logic.
    Uses latest closed candle only.
    """
    rr = get_current_rr()
...
# TRADE MANAGEMENT
# =========================================================
def resolve_same_candle(direction: str, hit_sl: bool, hit_tp: bool) -> Optional[str]:
...
def manage_pending_trade(m1: pd.DataFrame) -> None:
    ...
    for _, r in active_rows.iterrows():
        ...
        if sig.direction == "long":
            hit_sl = lo <= sig.sl
            hit_tp = hi >= sig.tp
            outcome = resolve_same_candle("long", hit_sl, hit_tp)
            ...
            hit_sl = hi >= sig.sl
            hit_tp = lo <= sig.tp
            outcome = resolve_same_candle("short", hit_sl, hit_tp)
